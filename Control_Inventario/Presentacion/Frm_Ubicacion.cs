...
namespace Presentacion
{
    public partial class Frm_Ubicacion : Form
    {
        ...
        Ubicacion descripcion_entidad = new Ubicacion();

        cnUbicacion descripcion_negocio = new cnUbicacion();

        cnUbicacion Listado = new cnUbicacion();
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            if (txtmarca.Text == "")
            {
                ...
                MessageBox.Show("Debe Ingresar la Ubicacion", "Aviso....", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void grilla_listado_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtmarca.Text = grilla_listado.CurrentRow.Cells["Ubicacion"].Value.ToString();
